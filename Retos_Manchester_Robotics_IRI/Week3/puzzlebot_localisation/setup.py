...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'controller = puzzlebot_localisation.controller:main',
            'controller2 = puzzlebot_localisation.controller2:main',
            'path_generator = puzzlebot_localisation.path_generator:main'
        ],
    },
)
