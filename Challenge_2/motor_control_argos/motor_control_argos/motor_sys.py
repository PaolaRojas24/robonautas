...
class motor_sys(Node):
    def __init__(self):
        ...
        self.motor_input_sub = self.create_subscription(Float32, 'motor_input_u_argos', self.input_callback,10)
        #expone la salida
        self.motor_speed_pub = self.create_publisher(Float32, 'motor_output_y_argos', 10)
